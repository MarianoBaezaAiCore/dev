@Projects @LippiaTestManager @DEV001_000050
Feature: Projects

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @DEV001_000044
  ...
  @Regresion @Ignore @DEV001_000047
