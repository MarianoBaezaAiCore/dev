@Projects @LippiaTestManager @DEV001_000378
Feature: Projects

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @DEV001_000372
  ...
  @Regresion @Ignore @DEV001_000375
