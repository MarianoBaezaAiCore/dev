@Projects @LippiaTestManager @DEV001_000207
Feature: Projects

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @DEV001_000201
  ...
  @Regresion @Ignore @DEV001_000204
