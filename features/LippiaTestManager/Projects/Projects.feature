@Projects @LippiaTestManager @DEV001_000321
Feature: Projects

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @DEV001_000315
  ...
  @Regresion @Ignore @DEV001_000318
