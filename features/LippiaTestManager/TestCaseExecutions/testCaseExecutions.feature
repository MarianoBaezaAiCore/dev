@TestCasesExecutions @LippiaTestManager @DEV001_000221
Feature: testCaseExecutions

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @DEV001_000218
  ...
  @Regresion @Smoke @Ignore @DEV001_000220
