@FeaturesT @LippiaTestManager @DEV001_000173
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000169
  ...
  @Regresion @Smoke @Ignore @DEV001_000170
  ...
  @Regresion @Smoke @Ignore @DEV001_000171
  ...
  @Regresion @Smoke @Ignore @DEV001_000172
