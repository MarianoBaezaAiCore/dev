@FeaturesT @LippiaTestManager @DEV001_000028
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000024
  ...
  @Regresion @Smoke @Ignore @DEV001_000025
  ...
  @Regresion @Smoke @Ignore @DEV001_000026
  ...
  @Regresion @Smoke @Ignore @DEV001_000027
