@FeaturesT @LippiaTestManager @DEV001_000066
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000062
  ...
  @Regresion @Smoke @Ignore @DEV001_000063
  ...
  @Regresion @Smoke @Ignore @DEV001_000064
  ...
  @Regresion @Smoke @Ignore @DEV001_000065
