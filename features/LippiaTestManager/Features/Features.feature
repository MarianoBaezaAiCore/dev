@FeaturesT @LippiaTestManager @DEV001_000229
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000225
  ...
  @Regresion @Smoke @Ignore @DEV001_000226
  ...
  @Regresion @Smoke @Ignore @DEV001_000227
  ...
  @Regresion @Smoke @Ignore @DEV001_000228
