@FeaturesT @LippiaTestManager @DEV001_000279
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000275
  ...
  @Regresion @Smoke @Ignore @DEV001_000276
  ...
  @Regresion @Smoke @Ignore @DEV001_000277
  ...
  @Regresion @Smoke @Ignore @DEV001_000278
