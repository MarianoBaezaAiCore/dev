@FeaturesT @LippiaTestManager @PWC001_000008
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @PWC001_000004
  ...
  @Regresion @Smoke @Ignore @PWC001_000005
  ...
  @Regresion @Smoke @Ignore @PWC001_000006
  ...
  @Regresion @Smoke @Ignore @PWC001_000007
