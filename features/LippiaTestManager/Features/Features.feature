@FeaturesT @LippiaTestManager @DEV001_000135
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000131
  ...
  @Regresion @Smoke @Ignore @DEV001_000132
  ...
  @Regresion @Smoke @Ignore @DEV001_000133
  ...
  @Regresion @Smoke @Ignore @DEV001_000134
