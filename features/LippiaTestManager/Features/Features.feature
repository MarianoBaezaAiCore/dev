@FeaturesT @LippiaTestManager @DEV001_000143
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000139
  ...
  @Regresion @Smoke @Ignore @DEV001_000140
  ...
  @Regresion @Smoke @Ignore @DEV001_000141
  ...
  @Regresion @Smoke @Ignore @DEV001_000142
