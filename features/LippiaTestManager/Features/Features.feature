@FeaturesT @LippiaTestManager @DEV001_000123
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000119
  ...
  @Regresion @Smoke @Ignore @DEV001_000120
  ...
  @Regresion @Smoke @Ignore @DEV001_000121
  ...
  @Regresion @Smoke @Ignore @DEV001_000122
