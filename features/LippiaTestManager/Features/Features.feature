@FeaturesT @LippiaTestManager @DEV001_000058
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000054
  ...
  @Regresion @Smoke @Ignore @DEV001_000055
  ...
  @Regresion @Smoke @Ignore @DEV001_000056
  ...
  @Regresion @Smoke @Ignore @DEV001_000057
