@FeaturesT @LippiaTestManager @DEV001_000165
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000161
  ...
  @Regresion @Smoke @Ignore @DEV001_000162
  ...
  @Regresion @Smoke @Ignore @DEV001_000163
  ...
  @Regresion @Smoke @Ignore @DEV001_000164
