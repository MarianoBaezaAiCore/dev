@FeaturesT @LippiaTestManager @DEV001_000356
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000352
  ...
  @Regresion @Smoke @Ignore @DEV001_000353
  ...
  @Regresion @Smoke @Ignore @DEV001_000354
  ...
  @Regresion @Smoke @Ignore @DEV001_000355
