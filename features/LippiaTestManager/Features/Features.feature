@FeaturesT @LippiaTestManager @DEV001_000307
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000303
  ...
  @Regresion @Smoke @Ignore @DEV001_000304
  ...
  @Regresion @Smoke @Ignore @DEV001_000305
  ...
  @Regresion @Smoke @Ignore @DEV001_000306
