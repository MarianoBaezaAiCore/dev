@FeaturesT @LippiaTestManager @DEV001_000249
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000245
  ...
  @Regresion @Smoke @Ignore @DEV001_000246
  ...
  @Regresion @Smoke @Ignore @DEV001_000247
  ...
  @Regresion @Smoke @Ignore @DEV001_000248
