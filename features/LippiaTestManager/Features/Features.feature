@FeaturesT @LippiaTestManager @DEV001_000078
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000074
  ...
  @Regresion @Smoke @Ignore @DEV001_000075
  ...
  @Regresion @Smoke @Ignore @DEV001_000076
  ...
  @Regresion @Smoke @Ignore @DEV001_000077
