@FeaturesT @LippiaTestManager @DEV001_000287
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000283
  ...
  @Regresion @Smoke @Ignore @DEV001_000284
  ...
  @Regresion @Smoke @Ignore @DEV001_000285
  ...
  @Regresion @Smoke @Ignore @DEV001_000286
