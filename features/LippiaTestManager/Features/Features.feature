@FeaturesT @LippiaTestManager @DEV001_000336
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000332
  ...
  @Regresion @Smoke @Ignore @DEV001_000333
  ...
  @Regresion @Smoke @Ignore @DEV001_000334
  ...
  @Regresion @Smoke @Ignore @DEV001_000335
