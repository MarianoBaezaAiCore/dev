@FeaturesT @LippiaTestManager @DEV001_000237
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000233
  ...
  @Regresion @Smoke @Ignore @DEV001_000234
  ...
  @Regresion @Smoke @Ignore @DEV001_000235
  ...
  @Regresion @Smoke @Ignore @DEV001_000236
