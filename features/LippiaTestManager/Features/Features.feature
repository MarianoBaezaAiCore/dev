@FeaturesT @LippiaTestManager @DEV001_000036
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000032
  ...
  @Regresion @Smoke @Ignore @DEV001_000033
  ...
  @Regresion @Smoke @Ignore @DEV001_000034
  ...
  @Regresion @Smoke @Ignore @DEV001_000035
