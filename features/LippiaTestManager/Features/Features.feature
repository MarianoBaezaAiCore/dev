@FeaturesT @LippiaTestManager @DEV001_000115
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000111
  ...
  @Regresion @Smoke @Ignore @DEV001_000112
  ...
  @Regresion @Smoke @Ignore @DEV001_000113
  ...
  @Regresion @Smoke @Ignore @DEV001_000114
