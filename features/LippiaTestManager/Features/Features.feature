@FeaturesT @LippiaTestManager @DEV001_000299
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000295
  ...
  @Regresion @Smoke @Ignore @DEV001_000296
  ...
  @Regresion @Smoke @Ignore @DEV001_000297
  ...
  @Regresion @Smoke @Ignore @DEV001_000298
