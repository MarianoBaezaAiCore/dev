@FeaturesT @LippiaTestManager @DEV001_000086
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000082
  ...
  @Regresion @Smoke @Ignore @DEV001_000083
  ...
  @Regresion @Smoke @Ignore @DEV001_000084
  ...
  @Regresion @Smoke @Ignore @DEV001_000085
