@FeaturesT @LippiaTestManager @DEV001_000344
Feature: Features

  Background:
    Given I perform the Token Request and save the token

  @Regresion @Smoke @Ignore @DEV001_000340
  ...
  @Regresion @Smoke @Ignore @DEV001_000341
  ...
  @Regresion @Smoke @Ignore @DEV001_000342
  ...
  @Regresion @Smoke @Ignore @DEV001_000343
