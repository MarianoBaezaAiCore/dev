@Users @LippiaTestManager @AUTBAC_000013
Feature: Users

  Background:
    Given I perform the Token Request and save the token

  @Regresion @AUTBAC_000008
