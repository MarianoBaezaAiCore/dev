@Suggesters @LippiaTestManager @DEV001_000328
Feature: Suggesters

  Background:
    Given I perform the Token Request and save the token

  @Regresion @DEV001_000326
